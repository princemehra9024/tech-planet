...
<!-- Fullscreen Menu Overlay -->
    <div id="fullscreen-menu" class="fixed inset-0 z-[105] flex items-center justify-center opacity-0 pointer-events-none transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] overflow-hidden" style="background-color: #000000; color: #ffffff;">
        ...
        <div class="max-w-[1400px] w-full mx-auto px-4 sm:px-10 flex flex-col md:flex-row justify-between h-full pt-[8rem] sm:pt-[9rem] pb-6 sm:pb-20 relative z-10 overflow-y-auto" style="-ms-overflow-style: none; scrollbar-width: none;">
            
            <!-- Navigation Links -->
            <div class="flex flex-col gap-2 sm:gap-3 md:gap-5 w-full md:w-2/3 justify-start pt-2 sm:pt-4" id="menu-links">
                <a href="{{ url('/') }}" data-hover="home" class="menu-item font-display font-black text-[2.5rem] sm:text-6xl md:text-7xl lg:text-[6rem] xl:text-[7rem] leading-[1.05] uppercase tracking-tighter transition-colors transform translate-y-12 opacity-0 inline-block w-full group/link"><span class="menu-item-text block w-max relative z-10" style="color: #ffffff;">Home</span></a>
                <a href="{{ url('/about') }}" data-hover="about" class="menu-item font-display font-black text-[2.5rem] sm:text-6xl md:text-7xl lg:text-[6rem] xl:text-[7rem] leading-[1.05] uppercase tracking-tighter transition-colors transform translate-y-12 opacity-0 inline-block w-full group/link"><span class="menu-item-text block w-max relative z-10" style="color: #ffffff;">About</span></a>
                <a href="{{ url('/events') }}" data-hover="events" class="menu-item font-display font-black text-[2.5rem] sm:text-6xl md:text-7xl lg:text-[6rem] xl:text-[7rem] leading-[1.05] uppercase tracking-tighter transition-colors transform translate-y-12 opacity-0 inline-block w-full group/link"><span class="menu-item-text block w-max relative z-10" style="color: #ffffff;">Events</span></a>
                <a href="{{ url('/gallery') }}" data-hover="gallery" class="menu-item font-display font-black text-[2.5rem] sm:text-6xl md:text-7xl lg:text-[6rem] xl:text-[7rem] leading-[1.05] uppercase tracking-tighter transition-colors transform translate-y-12 opacity-0 inline-block w-full group/link"><span class="menu-item-text block w-max relative z-10" style="color: #ffffff;">Gallery</span></a>
                <a href="{{ url('/contact') }}" data-hover="contact" class="menu-item font-display font-black text-[2.5rem] sm:text-6xl md:text-7xl lg:text-[6rem] xl:text-[7rem] leading-[1.05] uppercase tracking-tighter transition-colors transform translate-y-12 opacity-0 inline-block w-full group/link"><span class="menu-item-text block w-max relative z-10" style="color: #ffffff;">Contact</span></a>
